...
export default function Slide({
 ...
 return (
   <Card className="grid grid-cols-1 md:grid-cols-[1.8fr,3fr] w-full h-full overflow-hidden border-none shadow-none bg-transparent">
     <div className="relative h-[180px] sm:h-[200px] md:h-full">
       <img
         src={imageSrc}
         alt={title}
         className="absolute inset-0 w-[90%] h-full object-cover rounded-lg"
       />
     </div>

     <div className="p-4 sm:p-6 md:p-12 lg:p-16 flex flex-col gap-3 sm:gap-4 justify-center md:pl-16 lg:pl-20">
